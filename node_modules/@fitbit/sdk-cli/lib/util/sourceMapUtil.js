...
function appURItoPath(uri) {
    const normalized = path_1.default.normalize(uri.replace('app://', ''));
    return normalized[0] === '/' ? normalized.substring(1) : normalized;
}
exports.appURItoPath = appURItoPath;
function transformPosition(position, sourceMaps) {
    position.source = appURItoPath(position.source);
