...
function typescript(options) {
    const pluginOptions = Object.assign({ include: ['*.(t|j)s+(|x)', '**/*.(t|j)s+(|x)'], exclude: ['*.d.ts', '**/*.d.ts', 'node_modules/**'], tsconfig: undefined, tsconfigOverride: undefined, onDiagnostic: () => { } }, options);
    let filter;
    let parsedConfig;
    let service;
