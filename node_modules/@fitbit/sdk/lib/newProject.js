...
async function newProject() {
    ...
    const defaultDisplayName = typeof packageName === 'string'
        ? lodash_1.default.startCase(packageName)
        : undefined;
    const { appType, appDisplayName, withCompanion, withSettings, enabledBuildTargets, } = await inquirer_1.default
        .prompt([
        {
            name: 'appType',
            type: 'list',
        ...
        },
        {
            ...
            type: 'checkbox',
            choices: Object.values(ProjectConfiguration_1.BuildTarget).map((platform) => ({
                name: buildTargets_1.default[platform].displayName,
                value: platform,
            })),
            default: Object.values(ProjectConfiguration_1.BuildTarget),
    ...
    packageJSON.fitbit = Object.assign({}, config, { appType,
        appDisplayName, appUUID: uuid_1.default.v4(), buildTargets: enabledBuildTargets, wipeColor: '#ffffff' });
    packageJSON.scripts = {
        build: 'fitbit-build',
        debug: 'fitbit',
    };
    fs_extra_1.default.writeJSONSync(packageJSONPath, packageJSON, { spaces: 2, EOL: os_1.default.EOL });
}
