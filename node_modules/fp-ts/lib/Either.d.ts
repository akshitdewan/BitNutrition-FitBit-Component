 ...
 * @since 1.6.0
 */
export declare const fromRefinement: <L, A, B extends A>(refinement: Refinement<A, B>, whenFalse: (a: A) => L) => (a: A) => Either<L, B>;
/**
 ...
 * @since 1.0.0
 */
export declare const toError: (e: {}) => Error;
/**
 ...
 * @since 1.0.0
 */
export declare const tryCatch: <A>(f: Lazy<A>, onerror?: (e: {}) => Error) => Either<Error, A>;
/**
 * @function
 * @since 1.0.0
 */
