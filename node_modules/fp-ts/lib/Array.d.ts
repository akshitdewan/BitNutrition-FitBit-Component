 ...
 * @since 1.0.0
 */
export declare const getSetoid: <A>(S: Setoid<A>) => Setoid<Array<A>>;
/**
...
export declare const array: Monad1<URI> & Foldable1<URI> & Unfoldable1<URI> & Traversable1<URI> & Alternative1<URI> & Plus1<URI> & Extend1<URI> & Compactable1<URI> & Filterable1<URI> & Witherable1<URI>;
